...
export const LEAGUES: LeagueDef[] = [
  ...
  },
  {
    ...
    countryId: "sui",
    flag: "🇨🇭",
    clubs: buildClubs("sui", "sui", [
      ["young-boys", "BSC Young Boys", "YB", "#FFD700", "#000000", "Wankdorf Stadion", 1],
      ["basel", "FC Basel", "BAS", "#E30613", "#0A2250", "St. Jakob-Park", 1],
      ["servette", "Servette FC", "SER", "#C8102E", "#FFFFFF", "Stade de Genève", 2],
      ["zurich", "FC Zürich", "ZUR", "#F5F5F5", "#0067B1", "Letzigrund", 2],
      ["lugano", "FC Lugano", "LUG", "#000000", "#FFFFFF", "Cornaredo", 2],
      ["st-gallen", "FC St. Gallen", "STG", "#00843D", "#FFFFFF", "Kybunpark", 2],
      ["grasshopper", "Grasshopper", "GCB", "#F5F5F5", "#0067B1", "Letzigrund", 3],
      ["lausanne", "Lausanne-Sport", "LS", "#0067B1", "#FFFFFF", "Stade de la Tuilière", 3],
      ["luzern", "FC Luzern", "LUZ", "#0067B1", "#FFFFFF", "Swissporarena", 3],
      ["sion", "FC Sion", "SIO", "#C8102E", "#FFFFFF", "Stade de Tourbillon", 3],
      ["winterthur", "FC Winterthur", "WIN", "#C8102E", "#FFFFFF", "Schützenwiese", 4],
      ["yverdon", "Yverdon Sport", "YVE", "#00843D", "#FFFFFF", "Stade Municipal", 4]
    ]),
  },
  {
    id: "aut",
    ...
    countryId: "aut",
    flag: "🇦🇹",
    clubs: buildClubs("aut", "aut", [
      ["salzburg", "Red Bull Salzburg", "RBS", "#E32219", "#FFFFFF", "Red Bull Arena", 1],
      ["sturm", "SK Sturm Graz", "STU", "#000000", "#FFFFFF", "Merkur Arena", 1],
      ["lask", "LASK", "LAS", "#000000", "#FFFFFF", "Raiffeisen Arena", 2],
      ["rapid-wien", "Rapid Wien", "RAP", "#00843D", "#FFFFFF", "Allianz Stadion", 2],
      ["austria-wien", "Austria Wien", "FAK", "#5B2D8E", "#FFFFFF", "Generali Arena", 2],
      ["wolfsberger", "Wolfsberger AC", "WAC", "#000000", "#FFFFFF", "Lavanttal-Arena", 3],
      ["klagenfurt", "Austria Klagenfurt", "KLA", "#C8102E", "#FFFFFF", "Wörthersee Stadion", 3],
      ["hartberg", "TSV Hartberg", "HAR", "#FFED00", "#000000", "Profertil Arena", 3],
      ["wsg", "WSG Tirol", "WSG", "#00843D", "#FFFFFF", "Tivoli Stadion Tirol", 3],
      ["altach", "SCR Altach", "ALT", "#000000", "#FFFFFF", "Cashpoint Arena", 4],
      ["blau-weiss", "Blau-Weiß Linz", "BWL", "#0067B1", "#FFFFFF", "Hofmann Personal Stadion", 4],
      ["grazer", "Grazer AK", "GAK", "#C8102E", "#FFFFFF", "Merkur Arena", 4]
    ]),
  },
  {
    id: "cze",
    ...
    countryId: "cze",
    flag: "🇨🇿",
    clubs: buildClubs("cze", "cze", [
      ["slavia", "Slavia Praha", "SLP", "#C8102E", "#FFFFFF", "Fortuna Arena", 1],
      ["sparta", "Sparta Praha", "SPP", "#7B2D8E", "#FFD700", "epet Arena", 1],
      ["plzen", "Viktoria Plzeň", "VPL", "#0067B1", "#C8102E", "Doosan Arena", 2],
      ["ostrava", "Baník Ostrava", "OST", "#0067B1", "#FFFFFF", "Městský stadion", 2],
      ["slovacko", "1. FC Slovácko", "SLO", "#00843D", "#FFFFFF", "Městský fotbalový stadion", 3],
      ["mlada", "Mladá Boleslav", "MBA", "#0067B1", "#FFFFFF", "Lokotrans Aréna", 3],
      ["olomouc", "Sigma Olomouc", "SIG", "#0067B1", "#FFFFFF", "Andrův stadion", 3],
      ["jablonec", "FK Jablonec", "JAB", "#00843D", "#FFFFFF", "Stadion Střelnice", 3],
      ["hradec", "Hradec Králové", "HKR", "#C8102E", "#FFFFFF", "Malšovická aréna", 3],
      ["teplice", "FK Teplice", "TEP", "#FFD700", "#000000", "Na Stínadlech", 4],
      ["bohemians", "Bohemians 1905", "BOH", "#00843D", "#FFFFFF", "Ďolíček", 4],
      ["karvina", "MFK Karviná", "KAR", "#00843D", "#FFFFFF", "Městský stadion Karviná", 4]
    ]),
  },
  {
    id: "cro",
    ...
    countryId: "cro",
    flag: "🇭🇷",
    clubs: buildClubs("cro", "cro", [
      ["dinamo", "Dinamo Zagreb", "DZG", "#0067B1", "#FFFFFF", "Maksimir", 1],
      ["hajduk", "Hajduk Split", "HAJ", "#0067B1", "#FFFFFF", "Poljud", 1],
      ["rijeka", "HNK Rijeka", "RIJ", "#F5F5F5", "#0067B1", "Rujevica", 2],
      ["osijek", "NK Osijek", "OSI", "#0067B1", "#FFFFFF", "Opus Arena", 2],
      ["lokomotiva", "Lokomotiva", "LOK", "#00843D", "#FFFFFF", "Kranjčevićeva", 3],
      ["gorica", "HNK Gorica", "GOR", "#0067B1", "#FFFFFF", "Velika Gorica", 3],
      ["istra", "Istra 1961", "IST", "#FFD700", "#00843D", "Aldo Drosina", 3],
      ["slaven", "Slaven Belupo", "SLA", "#0067B1", "#FFFFFF", "Gradski stadion Koprivnica", 4],
      ["varazdin", "Varaždin", "VAR", "#0067B1", "#FFFFFF", "Stadion Varteks", 4],
      ["sibenik", "HNK Šibenik", "SIB", "#C8102E", "#FFFFFF", "Šubićevac", 4],
      ["vukovar", "Vukovar 1991", "VUK", "#0067B1", "#FFFFFF", "Gradski stadion Vukovar", 4],
      ["rudez", "NK Rudeš", "RUD", "#C8102E", "#FFFFFF", "Kranjčevićeva", 4]
    ]),
  },
  {
    id: "den",
    ...
    countryId: "den",
    flag: "🇩🇰",
    clubs: buildClubs("den", "den", [
      ["kobenhavn", "FC København", "FCK", "#0067B1", "#FFFFFF", "Parken", 1],
      ["midtjylland", "FC Midtjylland", "FCM", "#C8102E", "#FFFFFF", "MCH Arena", 1],
      ["brondby", "Brøndby IF", "BIF", "#FFD700", "#0067B1", "Brøndby Stadion", 2],
      ["agf", "AGF Aarhus", "AGF", "#F5F5F5", "#0067B1", "Ceres Park", 2],
      ["nordsjaelland", "FC Nordsjælland", "FCN", "#C8102E", "#FFFFFF", "Right to Dream Park", 2],
      ["randers", "Randers FC", "RFC", "#0067B1", "#FFFFFF", "Cepheus Park Randers", 3],
      ["silkeborg", "Silkeborg IF", "SIF", "#C8102E", "#FFFFFF", "JYSK Park", 3],
      ["viborg", "Viborg FF", "VFF", "#00843D", "#FFFFFF", "Energi Viborg Arena", 3],
      ["aab", "AaB Aalborg", "AAB", "#C8102E", "#FFFFFF", "Aalborg Portland Park", 3],
      ["lyngby", "Lyngby BK", "LBK", "#FFD700", "#000000", "Lyngby Stadion", 4],
      ["sonderjyske", "Sønderjyske", "SON", "#0067B1", "#FFFFFF", "Sydbank Park", 4],
      ["vejle", "Vejle BK", "VBK", "#C8102E", "#FFFFFF", "Vejle Stadion", 4]
    ]),
  },
  {
    id: "nor",
    ...
    countryId: "nor",
    flag: "🇳🇴",
    clubs: buildClubs("nor", "nor", [
      ["bodo", "Bodø/Glimt", "B/G", "#FFD700", "#000000", "Aspmyra", 1],
      ["molde", "Molde FK", "MOL", "#0067B1", "#FFFFFF", "Aker Stadion", 1],
      ["rosenborg", "Rosenborg", "RBK", "#000000", "#FFFFFF", "Lerkendal", 2],
      ["brann", "SK Brann", "BRA", "#C8102E", "#FFFFFF", "Brann Stadion", 2],
      ["viking", "Viking FK", "VIK", "#0067B1", "#FFFFFF", "SR-Bank Arena", 2],
      ["lillestrom", "Lillestrøm SK", "LSK", "#FFD700", "#000000", "Åråsen", 3],
      ["valerenga", "Vålerenga", "VIF", "#0067B1", "#C8102E", "Intility Arena", 3],
      ["tromso", "Tromsø IL", "TIL", "#C8102E", "#FFFFFF", "Romssa Arena", 3],
      ["odd", "Odd BK", "ODD", "#F5F5F5", "#0067B1", "Skagerak Arena", 3],
      ["sarpsborg", "Sarpsborg 08", "S08", "#0067B1", "#FFFFFF", "Sarpsborg Stadion", 3],
      ["hamkam", "HamKam", "HAM", "#00843D", "#FFFFFF", "Briskeby", 4],
      ["stromsgodset", "Strømsgodset", "STR", "#0067B1", "#FFFFFF", "Marienlyst", 4]
    ]),
  },
  {
    id: "swe",
    ...
    countryId: "swe",
    flag: "🇸🇪",
    clubs: buildClubs("swe", "swe", [
      ["malmo", "Malmö FF", "MFF", "#0067B1", "#FFFFFF", "Eleda Stadion", 1],
      ["aik", "AIK", "AIK", "#000000", "#FFD700", "Friends Arena", 2],
      ["djurgarden", "Djurgården", "DIF", "#0067B1", "#C8102E", "Tele2 Arena", 2],
      ["hammarby", "Hammarby IF", "HIF", "#00843D", "#FFFFFF", "Tele2 Arena", 2],
      ["elfsborg", "IF Elfsborg", "IFE", "#FFD700", "#000000", "Borås Arena", 2],
      ["hacken", "BK Häcken", "BKH", "#FFD700", "#000000", "Bravida Arena", 2],
      ["goteborg", "IFK Göteborg", "IFK", "#0067B1", "#FFFFFF", "Gamla Ullevi", 3],
      ["norrkoping", "IFK Norrköping", "IFN", "#F5F5F5", "#0067B1", "PlatinumCars Arena", 3],
      ["kalmar", "Kalmar FF", "KFF", "#C8102E", "#FFFFFF", "Guldfågeln Arena", 3],
      ["mjallby", "Mjällby AIF", "MAIF", "#FFD700", "#000000", "Strandvallen", 3],
      ["sirius", "IK Sirius", "SIR", "#0067B1", "#FFFFFF", "Studenternas IP", 4],
      ["varnamo", "IFK Värnamo", "IFV", "#00843D", "#FFFFFF", "Finnvedsvallen", 4]
    ]),
  },
  {
    id: "ukr",
    ...
    countryId: "ukr",
    flag: "🇺🇦",
    clubs: buildClubs("ukr", "ukr", [
      ["shakhtar", "Shakhtar Donetsk", "SHK", "#F5821F", "#000000", "Arena Lviv", 1],
      ["dynamo", "Dynamo Kyiv", "DYN", "#F5F5F5", "#0067B1", "NSC Olimpiyskiy", 1],
      ["dnipro", "Dnipro-1", "DN1", "#0067B1", "#FFFFFF", "Dnipro-Arena", 2],
      ["polissya", "Polissya Zhytomyr", "POL", "#00843D", "#FFFFFF", "Tsentralnyi Stadion", 2],
      ["zorya", "Zorya Luhansk", "ZOR", "#000000", "#FFFFFF", "Slavutych Arena", 3],
      ["kryvbas", "Kryvbas Kryvyi Rih", "KRY", "#C8102E", "#FFFFFF", "Hirnyk", 3],
      ["oleksandriya", "Oleksandriya", "OLE", "#00843D", "#FFFFFF", "Nika Stadium", 3],
      ["vorskla", "Vorskla Poltava", "VOR", "#00843D", "#FFFFFF", "Butovsky Vorskla", 3],
      ["chornomorets", "Chornomorets Odesa", "CHO", "#0067B1", "#FFFFFF", "Chornomorets Stadium", 4],
      ["veres", "Veres Rivne", "VER", "#C8102E", "#FFFFFF", "Avanhard Stadium", 4],
      ["obolon", "Obolon Kyiv", "OBO", "#00843D", "#FFFFFF", "Obolon Arena", 4],
      ["lnz", "LNZ Cherkasy", "LNZ", "#FFD700", "#000000", "Cherkasy Arena", 4]
    ]),
  },
  {
    id: "rou",
    ...
    countryId: "rou",
    flag: "🇷🇴",
    clubs: buildClubs("rou", "rou", [
      ["fcsb", "FCSB", "FCS", "#C8102E", "#0067B1", "Arena Națională", 1],
      ["cfr", "CFR Cluj", "CFR", "#7B2D8E", "#FFFFFF", "Dr. Constantin Rădulescu", 1],
      ["craiova", "Universitatea Craiova", "UCR", "#0067B1", "#FFFFFF", "Ion Oblemenco", 2],
      ["rapid-buc", "Rapid București", "RAP", "#FFD700", "#000000", "Rapid-Giulești", 2],
      ["farul", "Farul Constanța", "FAR", "#0067B1", "#FFFFFF", "Viitorul", 2],
      ["cluj-u", "Universitatea Cluj", "UCL", "#000000", "#FFFFFF", "Cluj Arena", 3],
      ["sepsi", "Sepsi OSK", "SEP", "#F5F5F5", "#C8102E", "Sepsi Arena", 3],
      ["botosani", "FC Botoșani", "BOT", "#C8102E", "#FFFFFF", "Municipal Botoșani", 3],
      ["iasi", "Poli Iași", "PIA", "#0067B1", "#FFFFFF", "Emil Alexandrescu", 4],
      ["otelul", "Oțelul Galați", "OTE", "#0067B1", "#FFFFFF", "Oțelul", 4],
      ["voluntari", "FC Voluntari", "VOL", "#00843D", "#FFFFFF", "Anghel Iordănescu", 4],
      ["petrolul", "Petrolul Ploiești", "PET", "#FFD700", "#0067B1", "Ilie Oană", 4]
    ]),
  },
  {
    id: "hun",
    ...
    countryId: "hun",
    flag: "🇭🇺",
    clubs: buildClubs("hun", "hun", [
      ["ferencvaros", "Ferencváros", "FTC", "#00843D", "#FFFFFF", "Groupama Aréna", 1],
      ["puskas", "Puskás Akadémia", "PAF", "#0067B1", "#FFFFFF", "Pancho Aréna", 2],
      ["fehervar", "Fehérvár", "FEH", "#0067B1", "#C8102E", "Sóstói Stadion", 2],
      ["debrecen", "Debreceni VSC", "DVSC", "#C8102E", "#FFFFFF", "Nagyerdei Stadion", 2],
      ["ujpest", "Újpest FC", "UJP", "#5B2D8E", "#FFFFFF", "Szusza Ferenc Stadion", 3],
      ["kte", "Kecskeméti TE", "KTE", "#0067B1", "#FFFFFF", "Széktói Stadion", 3],
      ["diosgyor", "Diósgyőri VTK", "DVTK", "#C8102E", "#FFFFFF", "Diósgyőri Stadion", 3],
      ["zte", "Zalaegerszegi TE", "ZTE", "#0067B1", "#FFFFFF", "ZTE Arena", 4],
      ["mtk", "MTK Budapest", "MTK", "#0067B1", "#FFFFFF", "Hidegkuti Nándor", 4],
      ["nyiregyhaza", "Nyíregyháza", "NYI", "#0067B1", "#FFFFFF", "Városi Stadion", 4],
      ["eto", "ETO FC Győr", "ETO", "#00843D", "#FFFFFF", "ETO Park", 4],
      ["paksi", "Paksi FC", "PAK", "#00843D", "#FFFFFF", "Fehérvári úti", 3]
    ]),
  },
  {
    id: "jpn",
    ...
    countryId: "jpn",
    flag: "🇯🇵",
    clubs: buildClubs("jpn", "jpn", [
      ["urawa", "Urawa Reds", "URA", "#C8102E", "#FFFFFF", "Saitama Stadium 2002", 1],
      ["yokohama-fm", "Yokohama F. Marinos", "YFM", "#0067B1", "#FFFFFF", "Nissan Stadium", 1],
      ["kawasaki", "Kawasaki Frontale", "KWF", "#0067B1", "#FFFFFF", "Todoroki", 1],
      ["kashima", "Kashima Antlers", "KAS", "#C8102E", "#FFFFFF", "Kashima Soccer Stadium", 2],
      ["kobe", "Vissel Kobe", "VIS", "#C8102E", "#FFFFFF", "Noevir Stadium", 1],
      ["hiroshima", "Sanfrecce Hiroshima", "SAN", "#5B2D8E", "#FFFFFF", "Edion Stadium", 2],
      ["fctokyo", "FC Tokyo", "FCT", "#0067B1", "#C8102E", "Ajinomoto Stadium", 2],
      ["gamba", "Gamba Osaka", "GAM", "#0067B1", "#000000", "Panasonic Stadium Suita", 2],
      ["nagoya", "Nagoya Grampus", "NAG", "#C8102E", "#FFFFFF", "Toyota Stadium", 3],
      ["cerezo", "Cerezo Osaka", "CER", "#FFD700", "#0067B1", "Yodoko Sakura Stadium", 3],
      ["fukuoka", "Avispa Fukuoka", "AVI", "#0067B1", "#FFFFFF", "Best Denki Stadium", 3],
      ["kyoto", "Kyoto Sanga", "KYT", "#5B2D8E", "#FFFFFF", "Sanga Stadium by Kyocera", 4]
    ]),
  },
  {
    id: "kor",
    ...
    countryId: "kor",
    flag: "🇰🇷",
    clubs: buildClubs("kor", "kor", [
      ["jeonbuk", "Jeonbuk Hyundai", "JHM", "#00843D", "#FFFFFF", "Jeonju World Cup Stadium", 1],
      ["ulsan", "Ulsan HD", "ULS", "#0067B1", "#FFFFFF", "Ulsan Munsu", 1],
      ["seoul", "FC Seoul", "SEO", "#C8102E", "#000000", "Seoul World Cup Stadium", 2],
      ["pohang", "Pohang Steelers", "PHS", "#C8102E", "#000000", "Pohang Steel Yard", 2],
      ["suwon", "Suwon Samsung Bluewings", "SSB", "#0067B1", "#FFFFFF", "Suwon World Cup Stadium", 3],
      ["incheon", "Incheon United", "ICU", "#0067B1", "#FFFFFF", "Sungui Arena", 3],
      ["daegu", "Daegu FC", "DGU", "#0067B1", "#FFFFFF", "DGB Daegu Bank Park", 3],
      ["gangwon", "Gangwon FC", "GWN", "#F5821F", "#000000", "Chuncheon Songam", 3],
      ["daejeon", "Daejeon Hana Citizen", "DHC", "#5B2D8E", "#FFFFFF", "Daejeon World Cup Stadium", 3],
      ["jeju", "Jeju United", "JJU", "#C8102E", "#FFFFFF", "Jeju World Cup Stadium", 4],
      ["gwangju", "Gwangju FC", "GWJ", "#FFD700", "#000000", "Gwangju Football Stadium", 4],
